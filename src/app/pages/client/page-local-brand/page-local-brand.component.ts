...
@Component({
  selector: 'app-page-local-brand',
  templateUrl: './page-local-brand.component.html',
  styleUrls: ['./page-local-brand.component.scss']
})
export class PageLocalBrandComponent implements OnInit{
  currentData:any = []
  ...
  changeSortBy(){
    ...
    this.objectFilter= this.removeNull(this.objectFilter)
    this.router.navigate(['/local-brand'], { queryParams: this.objectFilter });
    this.loadData()
  }
